...
export const pricingData = {
  ...
  description:
    "Paket Chat di bawah ini yang paling sering dipilih. CRM, Marketing, dan Cekat 360 punya paketnya sendiri, dan semuanya bisa digabung dalam satu kontrak.",
  plans: [
    {
      name: "Pro",
      description: "Untuk tim kecil yang mulai kewalahan balas chat.",
      popular: false,
      buttonStyle: "outline" as const,
      features: [
        { label: "WhatsApp Business API (WABA)", value: "1" },
        { label: "MAU (Monthly Active Users)", value: "3.000" },
    ...
    {
      name: "Business",
      popularBadge: "PALING DIPILIH",
      description: "Untuk bisnis yang butuh otomatisasi penuh dan alur kerja rapi.",
      popular: true,
      buttonStyle: "solid" as const,
      features: [
        { label: "WhatsApp Business API (WABA)", value: "3" },
        { label: "MAU (Monthly Active Users)", value: "10.000" },
    ...
    {
      name: "Enterprise",
      description: "Untuk volume chat besar dengan tim CS terstruktur.",
      popular: false,
      buttonStyle: "outline" as const,
      features: [
        { label: "WhatsApp Business API (WABA)", value: "5" },
        { label: "MAU (Monthly Active Users)", value: "30.000" },
    ...
    {
      name: "Custom",
      description: "Untuk kebutuhan khusus, integrasi, dan skala korporat.",
      popular: false,
      buttonStyle: "solid" as const,
      features: [
        { label: "WhatsApp Business API (WABA)", value: "Custom" },
        { label: "MAU (Monthly Active Users)", value: "Tanpa Batas" },
  ...
  footerNote: "Belum termasuk PPN",
  cta: {
    whatsappLabel: "Chat via WhatsApp",
    detailLabel: "Lihat detail harga",
    detailHref: "/fitur#harga",
  },
};
